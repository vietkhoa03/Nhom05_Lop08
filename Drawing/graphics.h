...
BOOL  PlotRect1(HDC hDC, HPEN hPen, COORD BGN, COORD END);
BOOL  PlotRect3(HDC hDC, HPEN hPen, COORD BGN, COORD END);
BOOL  PlotRect2(HDC hDC, HPEN hPen, COORD BGN, COORD END);
BOOL  PlotCirc1(HDC hDC, HPEN hPen, COORD BGN, COORD END);
BOOL  PlotCirc2(HDC hDC, HPEN hPen, COORD BGN, COORD END);
BOOL  PlotCirc3(HDC hDC, HPEN hPen, COORD BGN, COORD END);
BOOL  PlotCirc4(HDC hDC, HPEN hPen, COORD BGN, COORD END);
...
void circle1(int x, int y, int radius)
{
	...
	PlotCirc1(hDC, PEN, BGN, POS);
}
void circle2(int x, int y, int radius)
{
	BGN.X = (short)x + movx - radius / 2;
	BGN.Y = (short)y + mov - radius / 2;
	POS.X = (short)x + movx + radius / 2;
	POS.Y = (short)y + mov + radius / 2;
	PlotCirc2(hDC, PEN, BGN, POS);
}
void circle3(int x, int y, int radius)
{
	BGN.X = (short)x + movx - radius / 2;
	BGN.Y = (short)y + mov - radius / 2;
	POS.X = (short)x + movx + radius / 2;
	POS.Y = (short)y + mov + radius / 2;
	PlotCirc3(hDC, PEN, BGN, POS);
}
void circle4(int x, int y, int radius)
{
	BGN.X = (short)x + movx - radius / 2;
	BGN.Y = (short)y + mov - radius / 2;
	POS.X = (short)x + movx + radius / 2;
	POS.Y = (short)y + mov + radius / 2;
	PlotCirc4(hDC, PEN, BGN, POS);
}
void rectangle1(int x1, int y1, int x2, int y2)
{
	...
	POS.X = (short)x2 + movx;
	POS.Y = (short)y2 + mov;
	PlotRect1(hDC, PEN, BGN, POS);
}
void rectangle2(int x1, int y1, int x2, int y2)
{
	BGN.X = (short)x1 + movx;
	BGN.Y = (short)y1 + mov;
	POS.X = (short)x2 + movx;
	POS.Y = (short)y2 + mov;
	PlotRect2(hDC, PEN, BGN, POS);
}
void rectangle3(int x1, int y1, int x2, int y2)
{
	BGN.X = (short)x1 + movx;
	BGN.Y = (short)y1 + mov;
	POS.X = (short)x2 + movx;
	POS.Y = (short)y2 + mov;
	PlotRect3(hDC, PEN, BGN, POS);
}
...
{
	SelectObject(hDC, hPen);
	SelectObject(hDC, CreateSolidBrush(RGB(153, 153, 153)));
	return Rectangle(hDC, BGN.X, BGN.Y, END.X, END.Y);
}
BOOL  PlotCirc1(HDC hDC, HPEN hPen, COORD BGN, COORD END)
{
...
{
	SelectObject(hDC, hPen);
	SelectObject(hDC, CreateSolidBrush(RGB(0, 153, 255)));
	return Ellipse(hDC, BGN.X, BGN.Y, END.X, END.Y);
}
COORD setCordScale(COORD POS, RECT pRECT)
{
